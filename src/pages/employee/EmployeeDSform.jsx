...
export default function EmployeeDSform() {
  ...
  // Fetch current employee from localStorage/sessionStorage on load
  useEffect(() => {
    ...
    if (currentEmployee) {
      setFormData((prev) => ({
        ...
        employeeName: `${currentEmployee.name || ''} ${currentEmployee.surname || ''}`,
      }));
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-neutral-600">Employee Full Name</label>
          <input type="text" name="employeeName" value={formData.employeeName} onChange={handleChange} className="w-full p-2 border border-neutral-300 rounded" />
        </div>
        ...
        <div>
          ...
          <input type="datetime-local" name="sessionDateTime" value={formData.sessionDateTime} onChange={handleChange} className="w-full p-2 border border-neutral-300 rounded" />
        </div>
