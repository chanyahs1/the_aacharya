...
export default function EmployeeDetails() {
  ...
  useEffect(() => {
    // Get current employee from sessionStorage
  ...
  const handleEditClick = () => {
    setEditDetails(employee); // Pre-fill with current details
  ...
  const handleSubmitEdit = async () => {
    try {
      const res = await fetch(`https://the-aacharya.onrender.com/api/employees/details/${currentEmployee.id}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
